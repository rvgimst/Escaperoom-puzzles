...
char matrixSolvedText[] = "Computers online [UUDU]"; // use placeholders UDLR for arrow symbols, see below
...
void checkSoundOutputs() {
  if (soundTimerArmed) {
    if ((millis() - soundTimerStart) > soundTriggerPeriod) {
